...
@interface OrderFoodMerchantImageHorizonScrollCell()
@property(nonatomic, strong)OrderFoodMerchantImageHorizonColletionView *horizonView;
@end

@implementation OrderFoodMerchantImageHorizonScrollCell
